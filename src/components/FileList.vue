    ...
    <el-page-header>
      ...
      <template #breadcrumb>
        <el-breadcrumb separator="/">
          <el-breadcrumb-item :to="{ path: '/mainControl' }">homepage</el-breadcrumb-item>
          <el-breadcrumb-item :to="{ path: '/mainControl/11111111'}">11111111</el-breadcrumb-item>
...
export default {
  ...
  watch: {
    $route() {
      const _this = this
      console.log(_this.$route.params.filePath)
    }
  },
  data() {
    return {
