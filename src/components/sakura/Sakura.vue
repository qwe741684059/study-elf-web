...
<script>
import { SakuraUtil, SakuraList } from "./SakuraUtil.js";

export default {
  data() {
    return {
      sakuraNum: 50, //页面樱花数量 (添加)
  ...
  methods: {
    ...
    initSakura() {
      const img = new Image();
      img.src = require("./img/sakura.png"); //图片路径使用require才能获取
      // 绘制樱花
      const _this = this;
      SakuraUtil.prototype.draw = function(cxt) {
        cxt.save();
      ...
      // 修改樱花位置,模拟飘落.
      SakuraUtil.prototype.update = function() {
